...
ALTER TABLE agent_registry ADD COLUMN IF NOT EXISTS purpose TEXT NOT NULL DEFAULT '';
ALTER TABLE agent_registry ADD COLUMN IF NOT EXISTS passport_expires_at TEXT;
ALTER TABLE agent_registry ADD COLUMN IF NOT EXISTS eval_baseline_id TEXT;
