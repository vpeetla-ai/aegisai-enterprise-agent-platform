...
def seed_agents() -> tuple[RegisteredAgent, ...]:
    return (
        ...
        RegisteredAgent(
            ...
            name="Content Topic Architect",
            owner="AI Content Pipeline",
            business_domain="Content / Thought Leadership",
            risk_tier="low",
            autonomy_level=2,
            status="approved",
            model_provider="OpenAI/local fallback",
            allowed_tools=("notify.slack_publish",),
            data_classes=("internal",),
            last_run_at="not_run_yet",
            monthly_cost_usd=12.0,
            open_incidents=0,
            value_metric="Turns scout signals into LinkedIn/Substack topic briefs",
            budget_usd=15.0,
        ),
        RegisteredAgent(
